                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form method="POST" action="{{ route('front.surveyCreate') }}" id="frm_save">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 col-lg-5 col-sm-12 col-xs-12 col-md-5 form-group">
                                ...
                                <div class="col-4 col-lg-4 col-sm-12 col-xs-12 col-md-5 form-group">
                                ...
                                <div class="col-3 col-lg-3 col-sm-12 col-xs-12 col-md-5 form-group">
