...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h3>
                Gerador de Arquivos - Marcelo
            </h3>


            <!-- NOTE: TB3 form width default is 100%, so they expan to your <div> -->
            <form method="post" action="{{ url('/marcelo-gerador/organizaVisual') }}" class="form-horizontal">
                ...
                <a href="{{ url('/marcelo-gerador') }}" class="btn btn-info">Começar Novamente</a>
