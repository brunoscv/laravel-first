...
namespace App\Http\Controllers\Marcelo;
...
class GenerateController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->fileTypes = [
            ...
            [
                ...
                'caminho' => app_path() . DIRECTORY_SEPARATOR . 'Http/Controllers/Api/V1' . DIRECTORY_SEPARATOR . '__CLASSE__Controller.php',
            ],
            [
                'namespace' => 'Seeder',
    ...
    public function inicio()
    {
        ...
        foreach ($this->fileTypes as $tipo) {
            ...
            if ($tipo['namespace'] == 'Models') {
                $models = dirToArray($caminho);
        ...
        return view('marcelo-gerador.inicio', compact('allTables', 'mapeamento', 'models'));
    }
    ...
    public function mapa()
    {
        ...
        if (!empty(request('parent_class')))
            session(['parent_class' => request('parent_class')]);
        ...
        $conversaoDeLabels['alternative'] = 'Alternativas';
        ...
        return view('marcelo-gerador.mapa', compact('tableColumns', 'fileTypes', 'conversaoDeLabels', 'classe', 'camposListagem', 'camposOcultos', 'camposCadastro'));
    }
    ...
    public function organizaVisual()
    {
        ...
        return view('marcelo-gerador.organiza-visual', compact('campos_disponiveis', 'classe', 'arquivos'));
    }
    ...
    public function gera()
    {
        ...
        echo '<br /><a href="' . url('marcelo-gerador') . '">marcelo-gerador</a>';
...
';
    ...
    public function gerarController($arquivoController)
    {
        ...
        if (session()->exists('parent_class')) {
            $stub = $this->files->get($this->getStubPath() . '/SubController.stub');
            $stub = str_replace('{{parent_class}}', session('parent_class'), $stub);
            $stub = str_replace('{{parent_class_var}}', lcfirst(session('parent_class')), $stub);
        } else {
    ...
    public function gerarService($arquivoService)
    {
        ...
        if (session()->exists('parent_class')) {
            $stub = $this->files->get($this->getStubPath() . '/SubService.stub');
            $stub = str_replace('{{parent_class}}', session('parent_class'), $stub);
            $stub = str_replace('{{parent_class_var}}', lcfirst(session('parent_class')), $stub);
        } else {
    ...
    public function gerarModel($arquivoModel)
    {
        ...
        if (session()->exists('parent_class')) {
            $stub = $this->files->get($this->getStubPath() . '/SubModel.stub');
            $stub = str_replace('{{parent_class}}', session('parent_class'), $stub);
            $stub = str_replace('{{parent_class_var}}', lcfirst(session('parent_class')), $stub);
        } else {
...
<?php
/**
 * Criado por Marcelo Alves
 * Marcelo Alves Pereira marceloalvessoft@gmail.com
 * Date: {{date}}
 * Time: {{time}}
 */
...
class {{class}}Seeder extends Seeder
{
    ...
    public function gerarBarra()
    {
        ...
        if (session()->exists('parent_class')) {
            $stub = $this->files->get($this->getStubPath() . '/subnav.blade.php');
            $stub = str_replace('{{parent_class}}', session('parent_class'), $stub);
            $stub = str_replace('{{parent_class_var}}', lcfirst(session('parent_class')), $stub);
        } else {
    ...
    public function gerarIndex()
    {
        ...
        if (session()->exists('parent_class')) {
            $stub = $this->files->get($this->getStubPath() . '/subindex.blade.stub');
            $stub = str_replace('{{parent_class}}', session('parent_class'), $stub);
            $stub = str_replace('{{parent_class_var}}', lcfirst(session('parent_class')), $stub);
        } else {
...
';
    ...
    {
        if (session()->exists('parent_class')) {
            $stub = $this->files->get($this->getStubPath() . '/subform.blade.php');
            $stub = str_replace('{{parent_class}}', session('parent_class'), $stub);
            $stub = str_replace('{{parent_class_var}}', lcfirst(session('parent_class')), $stub);
        } else {
    ...
    public function atualizarRoutes()
    {
        ...
        if (session()->exists('parent_class')) {
            $route = lcfirst(session('parent_class')) . 's' . '/{' . lcfirst(session('parent_class')) . '}/' . session('tabela');
        } else {

            $route = session('tabela');
        ...
        $panel->resource(\'' . $route . '\', ' . $nomeDaClasse . 'Controller::class);';
