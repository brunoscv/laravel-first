                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" class="form-horizontal" id="frm_save" autocomplete="off"
                              action="{{ isset($item) ? route('{{table}}.update', [${{parent_class_var}}->id, $item->id]) : route('{{table}}.store', ${{parent_class_var}}->id) }}">
                        ...
                        <!-- fim dos campos -->
                            ...
                            @else
                                <a class="btn btn-default" id="ln_listar_form" href="{{ route('{{table}}.index', ${{parent_class_var}}->id) }}">
